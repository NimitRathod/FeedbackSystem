        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content border-cyan">
                <div class="modal-header bg-cyan white">
                    <h4 class="modal-title white" id="myModalLabel8">Add Subject</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form method="POST" action="/admin/subject" id="subjectAdd" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label>subject Name: </label>
                            <div class="form-group position-relative has-icon-left">
                                <input type="text" name="subject_name" placeholder="subject Name" class="form-control" value="">
                            </div>
                        </div>
                    </div>
                ...
                <form method="POST" action="" id="editform">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Subject Name: </label>
                            <div class="form-group position-relative has-icon-left">
                                <input type="text" class="form-control" required="true" id="subject_name" name="subject_name" placeholder="Enter subject Name">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.edit', function () {
        ...
        var id = $(this).data("id");
        var subject_name = $(this).data("subject-name");

        $('#editform #subject_name').val(subject_name);
    ...
    $(document).ready(function (e) {
        mytable = $('.dynamic-table').DataTable({
            ...
            "serverSide": true,
            "responsive": true,
            "ajax": "{{ url('admin/subject/getDataTable') }}",
            columns: [
            {data: "subject_name"},
            {data: "edit"},
            {data: "delete"}
        ...
        var addformValidator = $("#subjectAdd").validate({
            ignore: ":hidden",
            errorElement: "span",
